...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently working on an All-in-One Investment Tracker and Financial Freedom Planner",
...
export const projects = [
  {
    ...
    img: "/transpiler.jpg",
    iconLists: ["/python-original.svg", "/javascript-original.svg", "/html5-original.svg", "/css3-original.svg"],
    link: "https://github.com/Godzilla2405/Source_to_source_Transpiler",
  },
  // {
  //   id: 2,
  //   title: "Investment Tracker & Financial Planner",
...
export const skills = [
  {
    name: "React.js",
    level: "Advanced",
    description: "Built multiple projects including SPAs and dashboards using hooks, context API, and component-driven architecture.",
  },
  {
    name: "TypeScript",
    level: "Intermediate",
    description: "Comfortable using TypeScript in both frontend and backend projects to ensure strong typing and code safety.",
  },
  {
    name: "Node.js",
    level: "Intermediate",
    description: "Experience in building REST APIs and handling middleware, routing, and authentication logic.",
  },
  {
    name: "Python",
    level: "Intermediate",
    description: "Strong command of Python with a focus on automation and source-to-source transpiler development.",
  },
  {
    name: "C / C++",
    level: "Advanced",
    description: "Used extensively in the transpiler project to understand and generate low-level code from Python.",
  },
  {
    name: "Next.js",
    level: "Intermediate",
    description: "Built SSR and SSG apps with Next.js, optimizing SEO and performance.",
  },
  {
    name: "MongoDB / Mongoose",
    level: "Basic",
    description: "Used for storing and querying project data in full-stack MERN applications.",
  },
  {
    name: "Git & GitHub",
    level: "Intermediate",
    description: "Version control, branching, pull requests, and team collaboration using Git.",
  },
  {
    name: "Tailwind CSS",
    level: "Intermediate",
    description: "Styled all my recent frontend projects using Tailwind utility-first CSS framework.",
  },
];
